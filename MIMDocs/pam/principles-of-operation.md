...
- *PRIV*: A dedicated forest created especially for this PAM scenario. This forest includes one domain to accommodate privileged global or universal groups and accounts which are shadowed from one or more CORP domains.
